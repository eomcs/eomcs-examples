...
```bash
javap -c -classpath ./app/build/classes/java/main com.eomcs.quickstart.oop.exam12.App3\$BubbleSorter
```
...
```bash
javap -c -classpath ./app/build/classes/java/main com.eomcs.quickstart.oop.exam12.App4\$1BubbleSorter
```
...
```bash
javap -c -classpath ./app/build/classes/java/main com.eomcs.quickstart.oop.exam12.App5\$1
```
...
```bash
javap -c -p -v -classpath ./app/build/classes/java/main com.eomcs.quickstart.oop.exam12.App6
```
