...
package effectivejava.ch02.item5.exam04;
...
public class Test {
  public static void main(String[] args) throws Exception {
    ...
    // => 주입할 자원은 팩토리 메서드를 통해 얻는다.
    SpellChecker englishSpellChecker = new SpellChecker(new LexiconFactory("EN"));
    SpellChecker koreanSpellChecker = new SpellChecker(new LexiconFactory("KR"));
    SpellChecker computingSpellChecker = new SpellChecker(new LexiconFactory("COM"));
