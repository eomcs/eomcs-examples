...
package effectivejava.ch02.item5.exam03;
...
public class Test {
  public static void main(String[] args) throws Exception {
    ...
    // SpellChecker 사용할 자원을 외부에서 준비한다.
    EnglishLexicon englishLexicon = new EnglishLexicon();
    KoreanLexicon koreanLexicon = new KoreanLexicon();
    ComputingLexicon computingLexicon = new ComputingLexicon();

    // 필요한 자원을 생성자를 통해 SpellChecker 객체에 주입한다.
    SpellChecker englishSpellChecker = new SpellChecker(englishLexicon);
    SpellChecker koreanSpellChecker = new SpellChecker(englishLexicon);
    SpellChecker computingSpellChecker = new SpellChecker(englishLexicon);
