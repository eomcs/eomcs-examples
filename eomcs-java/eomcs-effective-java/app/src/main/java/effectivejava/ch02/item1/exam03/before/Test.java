...
package effectivejava.ch02.item1.exam03.before;
...
public class Test {
  public static void main(String[] args) {
    ...
    // [문제점]
    // - API 사용자가 구현 클래스 이름을 알아야 한다.
    SimpleInterestCalculator sic = new SimpleInterestCalculator(6.5);
    System.out.printf("%20.0f\n", sic.calculate(100_000_000, 3600));

    CompoundInterestCalculator cic = new CompoundInterestCalculator(6.5);
