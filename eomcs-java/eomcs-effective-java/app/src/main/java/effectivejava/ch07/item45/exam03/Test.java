...
package effectivejava.ch07.item45.exam03;

// [주제] 사전 하나를 훑어 원소 수가 많은 아나그램 그룹들을 출력하기 - 스트림 사용 후
  ...
  public static void main(String[] args) {
    ...
    try (Scanner s = new Scanner(dictionary)) {
      while (s.hasNext()) {
        ...
        groups
            .computeIfAbsent(
                alphabetize(word), // key
                (unused) -> new TreeSet<>()) // key가 존재하지 않으면 호출된다. 리턴 값을 value 사용.
            .add(word); // key 매핑된 TreeSet에 word를 추가한다.
      }
    } catch (Exception e) {
