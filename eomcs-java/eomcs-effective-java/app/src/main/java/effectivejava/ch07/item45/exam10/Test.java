...
package effectivejava.ch07.item45.exam10;

// [주제] 스트림과 반복 중 어느 쪽을 써야 할지 판단하기 힘들 예 - 스트림 사용

import static effectivejava.ch07.item45.exam10.Card.NEW_DECK;
...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    // [정리]
    // - 이전 예제의 반복문을 더 편하게 느끼는 프로그래머가 있을 것이고,
    //   이 예제의 스트림 파이프라인을 더 편하게 느끼는 프로그래머도 있을 것이다.
    // - 스트림 방식이 나아 보이고 동료들도 스트림 코드를 이해할 수 있고 선호한다면 스트림을 사용하라.
    // - 스트림과 반복 중 어느 것이 나은지 확신하기 어렵다면 둘 다 해보고 더 나은 쪽을 택하라.
  }
}
