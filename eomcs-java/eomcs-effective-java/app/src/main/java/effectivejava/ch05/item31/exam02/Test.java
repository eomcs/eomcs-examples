...
package effectivejava.ch05.item31.exam02;

// [주제] 한정적 와일드카드 타입을 사용한 경우
...
class Stack<E> {
  ...
  // Iterable의 원소 타입으로 E의 하위 타입을 모두 허용한다는 의미다.
  // push()의 파라미터가 E 타입이므로, E의 하위 타입을 넣는 것은 아무런 문제가 없다.
...
public class Test {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // [설명]
    // - pushAll()의 파라미터 타입은 Iterable<? extends Number>이다.
    //   즉 Iterable의 원소 타입으로 Number의 하위 타입이 모두 허용된다.
  }
}
