...
-- 주의: GENERATED ALWAYS AS IDENTITY 컬럼(id)은 INSERT 목록에서 제외
-- =============================================================================
...
VALUES ('김영희', 'kim@example.com', '부산', '해운대로 456', '48100',
        TO_TIMESTAMP('2024-01-15 11:30:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-02-20 14:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_customer (name, email, city, street, zipcode, created_at, updated_at)
VALUES ('이철수', 'lee@example.com', '대구', '동성로 789', '41000',
        TO_TIMESTAMP('2024-02-01 08:15:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-02-01 08:15:00', 'YYYY-MM-DD HH24:MI:SS'));
...
VALUES ('PHYSICAL', 'ASUS ROG Zephyrus G14', 1890000.00, 5,
        TO_TIMESTAMP('2024-01-06 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-01-06 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_product (dtype, name, price, stock, created_at, updated_at)
VALUES ('DIGITAL', 'Microsoft Office 365', 119000.00, 999,
        TO_TIMESTAMP('2024-01-07 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-01-07 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_product (dtype, name, price, stock, created_at, updated_at)
VALUES ('DIGITAL', 'Adobe Creative Cloud', 72600.00, 999,
        TO_TIMESTAMP('2024-01-08 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-01-08 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_product (dtype, name, price, stock, created_at, updated_at)
VALUES ('PHYSICAL', '남성 울 코트', 189000.00, 20,
        TO_TIMESTAMP('2024-01-09 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-01-09 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));
...
VALUES (1, 'CONFIRMED', TO_TIMESTAMP('2024-03-01 14:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-03-01 14:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-03-01 15:30:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_orders (customer_id, order_status, order_date, created_at, updated_at)
VALUES (1, 'DELIVERED', TO_TIMESTAMP('2024-02-15 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-02-15 10:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-02-20 18:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_orders (customer_id, order_status, order_date, created_at, updated_at)
VALUES (2, 'PENDING', TO_TIMESTAMP('2024-03-10 09:30:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-03-10 09:30:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_TIMESTAMP('2024-03-10 09:30:00', 'YYYY-MM-DD HH24:MI:SS'));
...
--    id: 1=김영희, 2=이철수
-- -----------------------------------------------------------------------------
INSERT INTO shop_cart (customer_id, created_at)
VALUES (2, TO_TIMESTAMP('2024-03-11 10:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO shop_cart (customer_id, created_at)
VALUES (3, TO_TIMESTAMP('2024-03-12 16:00:00', 'YYYY-MM-DD HH24:MI:SS'));
