...
- 자바 프로그램의 진입점(Entry Point) 규칙을 이해하고, JVM이 프로그램을 시작하는 방식을 설명할 수 있다.
- 스태틱 필드와 스태틱 메서드의 특성을 이해하고, 인스턴스 멤버와의 차이를 구분할 수 있다.
- 역할에 따라 클래스를 분리하는 이유를 이해하고, 단일 책임 원칙을 적용할 수 있다.
- 인스턴스와 인스턴스 필드의 개념을 이해하고, 객체를 생성하여 상태를 관리할 수 있다.
- 인스턴스 메서드와 `this` 참조의 동작 원리를 이해하고 활용할 수 있다.
- 스태틱 메서드의 한계를 이해하고, 인스턴스 메서드가 필요한 상황을 판단할 수 있다.
- 인스턴스 메서드 호출 메커니즘을 이해하고, 객체 간 협력 구조를 설계할 수 있다.
- 상속과 다형성의 원리를 이해하고, 인스턴스 메서드 오버라이딩을 활용할 수 있다.
- 인터페이스를 정의하고 구현하여 코드의 유연성과 교체 가능성을 높일 수 있다.
- 추상 클래스의 용도를 이해하고, 인터페이스와의 차이를 구분하여 적절하게 선택할 수 있다.
- 중첩 클래스(스태틱/논스태틱), 로컬 클래스, 익명 클래스, 람다, 메서드 레퍼런스의 특성과 용도를 이해하고 활용할 수 있다.
- 람다와 익명 클래스를 비교하고, 함수형 인터페이스와 함께 간결한 코드를 작성할 수 있다.
- 제네릭 타입과 제네릭 메서드를 정의하고, 타입 안정성을 확보하면서 재사용 가능한 코드를 작성할 수 있다.
- `Function`, `Consumer`, `Supplier`, `Predicate` 등 자주 사용하는 함수형 인터페이스를 이해하고 람다와 함께 활용할 수 있다.
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam02.App3
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam02.App4 --args="100 90 80"
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam03.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam05.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam05.App2
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam06.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam06.App2
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam08.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App2
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App3
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App4
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App5
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App6
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App7
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App8
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam11.App9
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam14.App
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam14.App2
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam14.App3
  ```
...
- 실행 명령:
  ```
  ./gradlew -q run -PmainClass=com.eomcs.advanced.oop.exam14.App4
  ```
